...
export const metadata = { title: "Creează organizație — QuizHub" }
...
type PlanTierRow = {
  ...
  max_useri: number
  max_examene: number
  tokeni_lunari: number | string | null
...
export default async function CreateOrgPage() {
  ...
  if (profile?.org_id != null) redirect("/profile")
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-12 sm:px-6 md:py-16 lg:px-8 lg:py-20">
        ...
        <CreateOrgForm tiers={selectableTiers} enterpriseTier={enterpriseTier} />
      </main>
    </div>
  )
}
